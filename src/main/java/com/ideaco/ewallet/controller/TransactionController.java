...
public class TransactionController {
    ...
    @GetMapping("/history")
    public ResponseEntity<List<TransferDTO>> getTransactionHistory(@RequestParam("user_id") int userId) {
        try {
            List<TransferDTO> transactionHistory = transactionService.getTransactionHistory(userId);
