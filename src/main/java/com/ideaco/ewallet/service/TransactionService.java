...
public class TransactionService {
    ...
    public List<TransferDTO> getTransactionHistory(int userId) throws UserNotFoundException {
        ...
        List<TransactionModel> transactionList = transactionRepository.findByTransactionSenderOrTransactionReceiver(userId, userId);

        List<TransferDTO> transferDTOList = new ArrayList<>();
        for (TransactionModel transactionModel : transactionList) {
            TransferDTO transferDTO = convertDTO(transactionModel);
